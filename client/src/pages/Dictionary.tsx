...
const TOOL_CARDS = [
  ...
  },
  {
    ...
    category: "Reference", 
    description: "Dictionary of the Tetum Language (INL), with nearly 10,000 entries. Definitions as in original document, spellchecked according to the INL standards",
    icon: Languages,
    color: "bg-purple-500",
